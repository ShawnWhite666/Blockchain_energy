...
public class MSecurityFilter implements Filter {
    //放行通过带有/xx前路径的请求
    private static final String[] freePrefixPaths = {"/css", "/fonts", "/images", "/js", "/layer", "/manager/mLogin", "/manager/mRegister"};
    //放行通过是/xx/uu的路径的请求
...
//        } catch (Exception e) {
//            e.printStackTrace();
//            Utils.outJson(response, Result.fail(Result.ERR_CODE_MANAGER_UNLOGIN, e.getMessage()));
//
//        }
    }
